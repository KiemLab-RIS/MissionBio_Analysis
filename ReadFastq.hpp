...
const std::string ScaddenFwd = "TCAAATCCCTCGGAAGCTGC";

int findOffset(const std::string &seq);

const std::string geCD33  = "CO-819_AMP47"; 
const std::string geCD117 = "CO-819_AMP29";
const std::string geHBG1  = "HbG_AMP1";
const std::string geHBG2  = "HbG_AMP2";



typedef struct _SCADDEN_CELL_MAP {
    std::map<std::string,int> sMap;
} SCADDEN_CELL_MAP,*PSCADDEN_CELL_MAP;
//
// data storage
//
//
